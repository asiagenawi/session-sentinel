...
from powernap_common import PROJECTS_DIR  # honors CLAUDE_CONFIG_DIR
...
assert "missed its alarm" in out.stdout, f"rescue not detected: {out.stdout!r} {out.stderr!r}"
